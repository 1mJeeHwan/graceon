...
export interface ResultDTOPlaylistDetail {
  resultCode?: string;
  resultMessage?: string;
  resultObject?: PlaylistDetail;
}
...
export interface ResultDTOChatKnowledgeDto {
  resultCode?: string;
  resultMessage?: string;
  resultObject?: ChatKnowledgeDto;
}
...
export type BannerDtoLinkType =
  (typeof BannerDtoLinkType)[keyof typeof BannerDtoLinkType];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const BannerDtoLinkType = {
  VIDEO: "VIDEO",
  MUSIC: "MUSIC",
  POST: "POST",
  URL: "URL",
...
export type AnnouncementDtoLinkType =
  (typeof AnnouncementDtoLinkType)[keyof typeof AnnouncementDtoLinkType];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const AnnouncementDtoLinkType = {
  VIDEO: "VIDEO",
  MUSIC: "MUSIC",
  POST: "POST",
  URL: "URL",
...
export interface AnnouncementDto {
   ...
   */
  linkUrl?: string;
  linkType?: AnnouncementDtoLinkType;
  linkRefId?: number;
  /**
   * @minLength 0
   * @maxLength 200
...
export interface ResultDTOAnnouncementDto {
  resultCode?: string;
  resultMessage?: string;
  resultObject?: AnnouncementDto;
}

export interface AnnouncementSortRequest {
  sortOrder?: number;
}
...
export interface ResultDTOMediaAssetDto {
  resultCode?: string;
  resultMessage?: string;
  resultObject?: MediaAssetDto;
}
...
export interface ResultDTOListAnnouncementDto {
  resultCode?: string;
  resultMessage?: string;
  resultObject?: AnnouncementDto[];
}
...
export interface ResultDTOListPlaylistDto {
  resultCode?: string;
  resultMessage?: string;
  resultObject?: PlaylistDto[];
}
...
export interface ResInfinityListMediaAssetDto {
  contents?: MediaAssetDto[];
  totalCount?: number;
  totalPage?: number;
}

export interface ResultDTOResInfinityListMediaAssetDto {
  resultCode?: string;
  resultMessage?: string;
  resultObject?: ResInfinityListMediaAssetDto;
}

export interface ResultDTOListString {
  resultCode?: string;
  resultMessage?: string;
  resultObject?: string[];
}
...
export interface ResultDTOListChatUnansweredDto {
  resultCode?: string;
  resultMessage?: string;
  resultObject?: ChatUnansweredDto[];
}
...
export interface ResultDTOChatStatsDto {
  resultCode?: string;
  resultMessage?: string;
  resultObject?: ChatStatsDto;
}
...
export interface ResultDTOListChatKnowledgeDto {
  resultCode?: string;
  resultMessage?: string;
  resultObject?: ChatKnowledgeDto[];
}
...
export type PublicContentDetailType =
  (typeof PublicContentDetailType)[keyof typeof PublicContentDetailType];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PublicContentDetailType = {
  VIDEO: "VIDEO",
  SOUND: "SOUND",
} as const;
...
export interface ResultDTOPublicContentDetail {
  resultCode?: string;
  resultMessage?: string;
  resultObject?: PublicContentDetail;
}
...
export type PublicChurchDetailDenomination =
  (typeof PublicChurchDetailDenomination)[keyof typeof PublicChurchDetailDenomination];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PublicChurchDetailDenomination = {
  METHODIST: "METHODIST",
  PCK: "PCK",
  HAPDONG: "HAPDONG",
  HOLINESS: "HOLINESS",
...
export interface PublicChurchDetail {
  id?: number;
  name?: string;
  denomination?: PublicChurchDetailDenomination;
  regionName?: string;
  address?: string;
  addressDetail?: string;
  zipcode?: string;
...
export interface ResultDTOPublicChurchDetail {
  resultCode?: string;
  resultMessage?: string;
  resultObject?: PublicChurchDetail;
}
...
export interface ResultDTOListPublicChannelItem {
  resultCode?: string;
  resultMessage?: string;
  resultObject?: PublicChannelItem[];
}
...
export type MediaPublicMediaFileParams = {
  key: string;
};
...
export type PublicChannelsParams = {
  type?: PublicChannelsType;
  limit?: number;
};

export type PublicChannelsType =
  (typeof PublicChannelsType)[keyof typeof PublicChannelsType];

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PublicChannelsType = {
  VIDEO: "VIDEO",
  SOUND: "SOUND",
} as const;
