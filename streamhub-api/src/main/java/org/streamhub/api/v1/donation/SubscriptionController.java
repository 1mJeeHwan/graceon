...
public class SubscriptionController {
    ...
    public ResultDTO<ResInfinityList<SubscriptionListItem>> list(
        ...
        return ResultDTO.ok(subscriptionService.list(request));
    }

    @Operation(summary = "구독 상세")
    @GetMapping("/{id}")
    public ResultDTO<SubscriptionDetail> detail(@PathVariable Long id) {
        return ResultDTO.ok(subscriptionService.getDetail(id));
    }
    ...
    public ResultDTO<SubscriptionDetail> changeStatus(
        ...
        return ResultDTO.ok(subscriptionService.changeStatus(id, request));
    }
}
